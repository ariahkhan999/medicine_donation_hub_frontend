                        ...
                        <div className="row">
                            ...
                            <div className="col-md-4">
                                <div className="footer-col">
                                    ...
                                    <p>
                                        Technology plays a dominant role in our lives. Technology make people up to date. We as a team making web application “Medicine Hub”.
                                    </p>
                                    <p>
                                        This is user friendly website for donors who want to make their donation system technology based, so they can easily manage all affairs related to the donation and to provide medicines to needy people. This deliverable is all about use case modeling and software design. 
                                    </p>
                                    </div>
                                </div>
                            </div>
