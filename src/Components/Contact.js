                        ...
                        <div className="col-md-4 col-md-offset-1 col-contact">
                            ...
                            <div className="contact-items">
                                <ul className="list-unstyled contact-items-list">
                                    <li className="contact-item"> <span className="contact-icon"> <i className="fa fa-phone"></i></span> +03327473984 </li>
                                    <li className="contact-item"> <span className="contact-icon"> <i className="fa fa-envelope"></i></span>se120182010@kust.edu.pk</li>
                                </ul>
                            </div>
                        </div>
                    </div>
